...
export const GITHUB_EDIT_URL = `https://github.com/woowacourse-study/2023-read-joconaco/edit/main`;
export const GITHUB_VIEW_URL = `https://github.com/woowacourse-study/2023-read-joconaco/blob/main`;
